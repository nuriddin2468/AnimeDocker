...
class AnimeModel(models.Model):
    ...
    studio = models.CharField(max_length=240, verbose_name="Студия", default=None)
    translate = models.CharField(max_length=240, verbose_name="Перевод", default=None)
    sound = models.CharField(max_length=240, verbose_name="Озвучивание", default=None)
    author = models.CharField(max_length=240, verbose_name="Автор оригинала/Сценарист", default=None)
